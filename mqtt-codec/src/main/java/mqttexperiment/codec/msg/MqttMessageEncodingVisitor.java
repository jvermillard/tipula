...
/**
 * Implement this class for reacting on different MQTT message without using a big ugly if/else/if of 'instanceof'.
 */
public interface MqttMessageEncodingVisitor {
    ...
    ByteBuffer visit(SubscribeMessage msg);

    ByteBuffer visit(SubAckMessage msg);
}
